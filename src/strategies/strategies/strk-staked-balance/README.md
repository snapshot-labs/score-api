...
1. **Pool delegator balances** — Calls `get_pool_member_info` on 200 whitelisted staking pool contracts (active stakers on 30th March 2026) to get delegated amounts.
