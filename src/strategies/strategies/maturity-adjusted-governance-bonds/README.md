...
4. Sum all weights. The raw sum is then divided by `10^decimals` for display purposes only — `decimals: 2` divides by 100 to match the portal UI convention. Set `decimals: 0` to use the raw integer weights as scores.
