...
export const SUBGRAPH_URL = {
  '137':
    'https://subgrapher.snapshot.org/subgraph/arbitrum/3Z8NRcpP7t2p4Lsi5iKBKgNqTrzf5ivthCEUCKAhH8NV'
};
...
export async function strategy(
  ...
  const subgraphResult = returnedFromSubgraph.map(x => x.votingWeights).flat();
